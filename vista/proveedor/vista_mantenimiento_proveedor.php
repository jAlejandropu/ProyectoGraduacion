        ...
        <form id="formularioRegistroProveedor">
          <div class="row">
            ...
            <div class="col-lg-6 mb-3">
              ...
              <input type="text" class="form-control" id="txtNumero" onkeypress="return soloNumeros(event)" placeholder="Ingrese el numero de documento (DPI, DNI etc..)" maxlength="17">
            </div>
            <div class="col-lg-6 mb-3">
...
<div class="modal fade" id="modal_editar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
      ...
      <div class="modal-body">
        <form id="formularioEditarProveedor">
          <div class="row">
            ...
            <div class="col-lg-6 mb-3">
    <label for="">Tipo Documento</label>
    <select class="form-control" id="cbmTipoDocumento" disabled>
        <option value="DPI">DPI</option>
        <option value="CUI">CUI</option>
        <option value="LICENCIA">LICENCIA</option>
        <option value="NIT">NIT</option>
    ...
    <div class="col-lg-6 mb-3">
    <label for="">Nro Documento</label>
    <input type="text" class="form-control" id="txtNumeroEditar" value="<?php echo $nroDocumento; ?>" disabled>
    <!-- Campo oculto para enviar el valor del número de documento -->
    <input type="hidden" name="txtNumeroEditar" value="<?php echo $nroDocumento; ?>">
      </div>
