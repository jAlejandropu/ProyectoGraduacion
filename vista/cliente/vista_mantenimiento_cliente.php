          ...
          <div class="row">
            ...
            <div class="col-lg-6 mb-2">
              ...
              <select class="form-control" id="cbmTipoDocumento" style="width: 100%;">
                <option value="CUI">Nit</option>
                <option value="DPI">LINCENCIA</option>
                <option value="LICENCIA">DPI</option>
                <option value="PASAPORTE">PASAPORTE</option>
              </select>
            </div>
            <div class="col-lg-6 mb-2">
              <label for="">Nro Documento</label>
              <input type="text" class="form-control" id="txtNumero" onkeypress="return soloNumeros(event)" placeholder="Ingrese el numero de documento (CUI, DPI etc..)" maxlength="17">
            </div>
            <div class="col-lg-6 mb-2">
