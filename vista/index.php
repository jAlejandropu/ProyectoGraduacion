...
<head>
    ...
    <title>Taller Cat Quinilla</title>
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <?php if (true) { ?>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item" <?php  if(!in_array('14', $_SESSION['S_ACCESOS'])) echo 'hidden'; ?>>
                                        <a href="#" class="nav-link" onclick="cargarContenido('contenido-principal', 'caja/caja.php')">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Caja</p>
                                        </a>
                                    </li>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy;<a href="#">Taller Cat Quinilla, Taller Cat Quinilla</a>.</strong> Todos los derechos reservados.
        </footer>
    </div>
    <!-- ./wrapper -->
