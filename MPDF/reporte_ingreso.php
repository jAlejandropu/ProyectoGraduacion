          ...
          if ($row['ingreso_tipcomprobante'] == "FACTURA" || $row['ingreso_tipcomprobante'] == "AJUSTE") {
            $html.='
              ...
              <tr>
                ...
                <td class="total" style="background: #ffffff">Q. '.($row['ingreso_total'] - $row['ingreso_impuesto']) .'</td>
              </tr>
             
              <tr>
                <td colspan="2" style="background: #ffffff"><b>TOTAL NETO</b></td>
                <td class="grand total" style="background: #ffffff">Q. '.$row['ingreso_total'].'</td>
              </tr>';
          } else {
            $html.= '<tr>
              <td colspan="4"><b>TOTAL NETO</b></td>
              <td class="grand total">Q. '.$row['ingreso_total'].'</td>
            </tr>';
          }  
            $html.='
          </tbody>
