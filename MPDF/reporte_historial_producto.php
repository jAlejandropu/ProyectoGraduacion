...
if ($resultado) {
  while ($row = $resultado->fetch_assoc()) {         
    ...
    <html lang="en">
      <head>
        <meta charset="utf-8">
        <title>HISTORIAL DE CAMBIO DE PRODUCTO</title>
            ...
            <thead>
                <tr>
                    ...
                    <th style="text-align: center;">
                      ...
                      <h2 style="color: black;">HISTORIAL DE CAMBIO DE PRODUCTO </h2>
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>SIN HISTORIAL DE CAMBIO DE PRODUCTO</title>
    <link rel="stylesheet" href="style.css" media="all" />
  </head>
  <body>
  <h3>SIN HISTORIAL DE CAMBIO DE PRODUCTO</h3>
  </body>
  </html>
